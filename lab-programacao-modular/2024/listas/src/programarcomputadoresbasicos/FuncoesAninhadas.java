...
public final class FuncoesAninhadas {
    ...
    private static void exibirResultados(final double numero, final double raiz, final double arredondado, final double exponencial) {
        Console.printf("Número inicial: %.2f%n", numero);
        Console.printf("Raiz quadrada: %.6f%n", raiz);
        Console.printf("Valor arredondado: %.0f%n", arredondado);
        Console.printf("Exponencial do valor arredondado: %.6f%n", exponencial);
    }
}
