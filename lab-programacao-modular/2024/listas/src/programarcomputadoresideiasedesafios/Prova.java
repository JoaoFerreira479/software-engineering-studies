...
public final class Prova {
    ...
    public void cadastrarGabarito(final Scanner scanner) {
        Console.println("Digite o gabarito das questões (V para Verdadeiro, F para Falso):");
    ...
    public void cadastrarRespostasAluno(final Scanner scanner, final String nomeAluno) {
        ...
        Console.println("Digite as respostas do aluno " + nomeAluno + " (V para Verdadeiro, F para Falso):");
    ...
    public void exibirResultados() {
        Console.println("\nResultados:");
        for (final Aluno aluno : alunos) {
            Console.printf("Aluno: %s - Nota: %d/%d%n", aluno.getNome(), aluno.getNota(), gabarito.length);
        }
    }
}
