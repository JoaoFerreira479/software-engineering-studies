...
public final class ListaDeCompras {
    ...
    public void exibirLista() {
        if (itens.isEmpty()) {
            Console.println("A lista de compras está vazia.");
        } else {
            Console.println("Itens na lista de compras:");
            for (int i = 0; i < itens.size(); i++) {
                Console.println((i + 1) + ". " + itens.get(i));
            }
        }
    }
    ...
    public void imprimirLista() {
        if (itens.isEmpty()) {
            ...
            Console.println("Lista de compras:");
            itens.forEach(item -> Console.println("- " + item));
        }
    }
}
