...
public final class Adivinhe {
    ...
    public static void main(final String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            Console.println("Bem-vindo ao jogo 'Adivinhe o Número'!");
            Console.printf("Eu vou pensar em um número entre %d e %d. Você tem %d tentativas para adivinhar.%n",
    ...
    private static void executarJogo(final Scanner scanner) {
        ...
        for (int tentativa = 1; tentativa <= MAX_TENTATIVAS; tentativa++) {
            ...
            if (chute == numeroSorteado) {
                Console.printf("Parabéns! Você acertou! O número era %d.%n", numeroSorteado);
                return;
            }
            Console.println(chute < numeroSorteado ? "O número é maior que o seu palpite." : "O número é menor que o seu palpite.");
        }
        Console.printf("Você perdeu! O número era %d.%n", numeroSorteado);
    }
}
