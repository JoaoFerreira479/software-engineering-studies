...
public final class Criptografia2 {
            ...
            do {
                ...
                switch (opcao) {
                    case 1 -> {
                        ...
                        Console.println("Cadeia criptografada: " + criptografar(input));
                    }
                    case 2 -> {
                        final String input = EntradaUtil.lerLinha(scanner, "Digite a cadeia a ser decifrada: ");
                        try {
                            Console.println("Cadeia decifrada: " + decifrar(input));
                        } catch (IllegalArgumentException e) {
                            Console.println("Erro: " + e.getMessage());
                        }
                    }
                    case 3 -> Console.println("Saindo...");
                    default -> Console.println("Opção inválida. Escolha uma opção entre 1 e 3.");
                }
            } while (opcao != 3);
        }
    }
    ...
    private static void exibirMenu() {
        ...
        Console.println("1. Criptografar");
        Console.println("2. Decifrar");
