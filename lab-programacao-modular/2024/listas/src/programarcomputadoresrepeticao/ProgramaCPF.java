...
public final class ProgramaCPF {
    ...
    public static void main(final String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            Console.println("Primeiro dígito verificador (DV1): " + dv1);
            Console.println("Segundo dígito verificador (DV2): " + dv2);
            Console.println("Número de controle do CPF: " + numeroDeControle);
