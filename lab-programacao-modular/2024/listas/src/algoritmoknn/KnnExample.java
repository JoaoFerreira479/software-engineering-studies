...
public final class KnnExample {
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            Console.erro("Erro ao ler arquivo: " + e.getMessage());
        } catch (IllegalArgumentException e) {
            Console.erro("Erro de dados: " + e.getMessage());
        }
    }
    ...
    private static void executarInterativo(final KnnClassifier classifier) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            Console.println("Classificação: " + estado);
        }
    }
    ...
    private static double lerDouble(
        ...
        while (true) {
            ...
            Console.println("Valor fora do intervalo [" + min + ", " + max + "]. Tente novamente.");
        }
    }
}
