...
public final class GerenciadorEventosMain {
        ...
        try (BufferedReader in = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            while ((comando = in.readLine()) != null && !comando.trim().equals("FIM")) {
                ...
                if (cmd.startsWith("PESQUISAR")) {
                    ...
                    if (encontrado != null) {
                        Console.println("Evento encontrado: " + encontrado);
                    } else {
                        Console.println("Evento nao encontrado");
                    }
    ...
    private static void imprimirEventosPorData(ABB<Evento> abb, LocalDate data) {
        Console.println("Eventos do dia " + data.format(ENTRADA_DATA));
        abb.emOrdem(e -> {
            if (e.getData().equals(data)) {
                Console.println(e.getNome());
            }
        });
    }
}
