...
import aed2.domain.ordenacao.BubbleSort;
...
public final class BubbleSortMain {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader in = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            BubbleSort<MedalhistaComContagem> bubbleSort = new BubbleSort<>(aOrdenar);
            bubbleSort.setComparador(OrdenacaoMainHelper.comparadorMedalhas());
            bubbleSort.ordenar();
