...
import aed2.domain.estruturas.Conjunto;
...
public final class GerenciadorListaEncadeadaMain {
    ...
    public static void main(String[] args) {
        ...
        Console.println("LISTA DE MEDALHISTAS SEM REPETICAO");
        ...
        Console.println("LISTA INVERTIDA DE MEDALHISTAS");
        lista.paraCadaReverso(m -> Console.println(m.toString()));
    }
