...
public final class PesquisaComparacaoMain {
    ...
    public static void main(String[] args) {
        ...
        Console.println("Pesquisa Sequencial:");
        Console.println("N\tCenário\tComparações\tTempo (ns)");
        int n = N_INICIAL;
        while (n <= LIMITE_N) {
    ...
    public static void realizarTeste(String tipo, String caso, int[] vetor, int chave) {
        ...
        Console.println(vetor.length + "\t" + caso + "\t" + comparacoes + "\t" + tempoMedio);
    }
